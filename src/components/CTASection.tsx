                        ...
                        {[
                            {
                                ...
                                glow: "rgba(16, 185, 129, 0.4)", // Neon Green
                            ...
                            },
                            {
                                ...
                                glow: "rgba(255, 0, 110, 0.4)", // Neon Pink
                            ...
                            },
                            {
                                ...
                                glow: "rgba(99, 102, 241, 0.4)", // Neon Indigo
                                color: "text-white",
                            },
                            {
                                name: "Gmail",
                            ...
                            <motion.a
                                ...
                                whileHover={{
                                    scale: 1.08,
                                    y: -5,
                                    boxShadow: `0 0 30px ${link.glow.replace('0.4', '0.6')}`,
                                    borderColor: link.glow.replace('0.4', '0.8')
                                }}
                                whileTap={{ scale: 0.95 }}
                                style={{
                                    boxShadow: `0 0 20px ${link.glow}`,
                                    borderColor: link.glow.replace('0.4', '0.3'),
                                }}
                                className={`group flex items-center gap-3 px-6 py-3.5 rounded-xl border bg-dark-900/80 ${link.color} transition-all duration-500 shadow-xl`}
                            >
                                <span className="drop-shadow-[0_0_8px_rgba(255,255,255,0.3)]">{link.icon}</span>
                                <span className="text-sm font-bold tracking-wider uppercase">{link.name}</span>
                            </motion.a>
                        ))}
                    </div>
                </ScrollReveal>
